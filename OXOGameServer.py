            ...
            try:
                ...
                while True:
                    ...
                    while not self.is_game_finished():
                        self.send_message(self.current_player,'your move')  # Sends message to client
                        self.send_message(self.current_player ^ 1,'opponents move') # Sends message to client
                        
                        # Recieve message from clients (Position)
                        ...
                        # Make move if its valid    
                            ...
                            move_position = int(move_position)  # integer conversion
